...
class CreateComplaintRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        [
            ...
            'invoice'               => 'required|image|mimes:jpeg,png,jpg,image/jpeg,image/png,image/jpg|max:2048',
            'picture_1'             => 'required|image|mimes:jpeg,png,jpg,image/jpeg,image/png,image/jpg|max:2048',  // For multiple pictures
            'picture_2'             => 'image|mimes:jpeg,png,jpg,image/jpeg,image/png,image/jpg|max:2048',  // For multiple pictures
            'picture_3'             => 'image|mimes:jpeg,png,jpg,image/jpeg,image/png,image/jpg|max:2048',  // For multiple pictures
            'picture_4'             => 'image|mimes:jpeg,png,jpg,image/jpeg,image/png,image/jpg|max:2048',  // For multiple pictures
            'picture_5'             => 'image|mimes:jpeg,png,jpg,image/jpeg,image/png,image/jpg|max:2048',  // For multiple pictures
        ];
    }
