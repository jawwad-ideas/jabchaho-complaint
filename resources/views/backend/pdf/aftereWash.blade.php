                                                                            ...
                                                                            <span style="width:50%;float:left;">
                                                                                <a href="{{ url('assets/uploads/orders/'.$orderNo.'/before/'.Arr::get($orderItemsImage, 'imagename')) }}" style="text-decoration: none; display:block;" download>
                                                                                    @if(File::exists(public_path('assets/uploads/orders/'.$orderNo.'/thumbnail/before/'.Arr::get($orderItemsImage, 'imagename'))))
                                                                                        <img src="{{ public_path('assets/uploads/orders/'.$orderNo.'/thumbnail/before/'.Arr::get($orderItemsImage, 'imagename')) }}" style="max-width:30px;height:35px;"  />
                                                                                    @else
                                                                                        <img src="{{ public_path('assets/uploads/orders/'.$orderNo.'/before/'.Arr::get($orderItemsImage, 'imagename')) }}" style="max-width:30px;height:35px;"  />
                                                                                    @endif
                                                                                </a>
                                                                            </span>
                                                                            @endif
                                                                            ...
                                                                            <span style="width:50%;float:left;">
                                                                                <a href="{{ url('assets/uploads/orders/'.$orderNo.'/after/'.Arr::get($orderItemsImage, 'imagename')) }}" style="text-decoration: none;display:block;" download>
                                                                                    @if(File::exists(public_path('assets/uploads/orders/'.$orderNo.'/thumbnail/after/'.Arr::get($orderItemsImage, 'imagename'))))
                                                                                        <img src="{{ public_path('assets/uploads/orders/'.$orderNo.'/thumbnail/after/'.Arr::get($orderItemsImage, 'imagename')) }}" style="max-width:30px;" />
                                                                                    @else
                                                                                        <img src="{{ public_path('assets/uploads/orders/'.$orderNo.'/after/'.Arr::get($orderItemsImage, 'imagename')) }}" style="max-width:30px;" />
                                                                                    @endif
                                                                                </a>
                                                                            </span>
                                                                            @endif
