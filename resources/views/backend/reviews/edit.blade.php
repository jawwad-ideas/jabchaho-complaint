            ...
            <div class="col-lg-12">
                ...
                <div class="container mt-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="@if (old('name')) {{ old('name') }}@elseif(empty(old('name')) && old('_token')) {{ '' }}@else{{ Arr::get($review, 'name') }} @endif" type="text" class="form-control" name="name" placeholder="Name">

                    </div>

                    <div class="mb-3">
                        <label for="email" class="form-label">Review</label>
                        <textarea class="form-control" name="comments" rows="3" cols="50">@if(old('comments')){{old('comments')}}@elseif(empty(old('comments')) && old('_token')) {{''}}@else{{ Arr::get($review, 'comments') }} @endif</textarea>
                    </div>
