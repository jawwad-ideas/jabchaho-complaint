...
<div class="page-title-section border-bottom mb-1 d-lg-flex justify-content-between align-items-center d-block bg-theme-yellow">
    ...
    <div class="text-xl-start text-md-center text-center mt-xl-0 mt-3">
        <div class="btn-group" role="group">
            <button type="submit" name="exportComplaint" value="exportComplaint" id="exportButton" form="exportComplaints"
...
<div class="page-content bg-white p-lg-5 px-2">
    <div class="bg-light p-2 rounded">
        ...
        <div class="" id="filterBox" 
                ...
                @endif
        >
            <form class="form-inline" method="GET" action="{{ route('complaints.index') }}" id="exportComplaints">
