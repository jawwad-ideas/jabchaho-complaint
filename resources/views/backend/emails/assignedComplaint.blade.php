                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="main-content" style="vertical-align:top;background-color:#efef;padding:30px;">
                                ...
                                <p class="greeting" style="margin-top:0;margin-bottom:10px">A complaint  <b style="margin-top:0;margin-bottom:10px">(NO: {{$complaintNumber}})</b> with Priority: <b>{{$priority}}</b> has been assigned to you for resolution.</p>
