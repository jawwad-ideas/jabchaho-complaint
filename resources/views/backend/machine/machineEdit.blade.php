...
@section('content')
    <div
        ...
        <div class="p-title">
            <h3 class="fw-bold text-dark m-0">Edit Machine</h3>
        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-section mb-5">
                        <div class="form-section mb-5 form-section-title m-xl-0 mx-2 my-3">
                            <h4 class="fw-bold mt-0">Edit Machine</h4>
                        </div>
                    </div>
                    ...
                    <div class="container mt-4">
                        <div class="mb-3">
                            ...
                            <input value="{{ $machine->name }}" type="text" class="form-control" name="name"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select p-2" id="is_enabled" name="is_enabled">
                                <option value="" {{ $machine->is_enabled === null ? 'selected' : '' }}>Status</option>
                                @foreach($statusOptions as $key => $option)
                                    <option value="{{ $key }}" {{ (string)$key === (string)$machine->is_enabled ? 'selected' : '' }}>
                                        {{ ucfirst($option) }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <input value="{{ $machine->id }}" type="hidden" class="form-control" name="machine_id" placeholder="Machine Id" readonly>
