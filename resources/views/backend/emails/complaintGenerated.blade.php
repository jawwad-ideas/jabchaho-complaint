                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="main-content" style="vertical-align:top;background-color:#efef;padding:30px;">
                                ...
                                <b style="margin-top:0;margin-bottom:10px">Your complaint has been registered successfully.</b>
                                ...
                                <div style="margin-top: 20px;">
                                    ...
                                    <div style="width:100%;display:flex;padding:10px 5px;">
                                        <b style="width:25%;">Complaint Nature: </b><span>{{$complaintType}}</span>
                                    </div>
                                    <div style="width:100%;display:flex;padding:10px 5px;">
                                        <b style="width:25%;">Service: </b><span>{{$service}}</span>
                                    </div>
                                    <div style="width:100%;display:flex;padding:10px 5px;">
