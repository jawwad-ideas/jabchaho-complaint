...
class OrderSaveRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'image.*.pickup_images.*.max' => 'Each Pick Up image must not exceed 5 MB.',
            ...
            'image.*.delivery_images.*.max' => 'Each Delivery image must not exceed 5 MB.',
            ...
            'remarks_attachment.*.max' => 'Each Delivery image must not exceed 5 MB.',
        ];
    }
}
