...
@section('content')
    <div
        ...
        <div class="p-title">
            <h3 class="fw-bold text-white m-0">Add Union
                Council</h3>
        </div>
    ...
    <div class="page-content bg-white p-lg-5 px-2">
        ...
        <form method="post" action="{{ route('union.council.create') }}" autocomplete="off">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-section mb-5">
                        <div class="form-section mb-5 form-section-title m-xl-0 mx-2 my-3">
                            <h4 class="fw-bold mt-0">Add a Union
                                Council</h4>
                        </div>
                    </div>
                    <div class="container mt-4">
                        ...
                        <button type="submit"
                            class="btn bg-theme-green text-white d-inline-flex align-items-center gap-3">Create Union
                            Council</button>
