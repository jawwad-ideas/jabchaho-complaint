...
@section('content')
    <div
        ...
        <div class="p-title">
            <h3 class="fw-bold text-white m-0">Add Provincial Assembly</h3>
        </div>
    ...
    <div class="page-content bg-white p-lg-5 px-2">
        ...
        <form method="post" action="{{ route('pa.create') }}" autocomplete="off">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-section mb-5">
                        <div class="form-section mb-5 form-section-title m-xl-0 mx-2 my-3">
                            <h4 class="fw-bold mt-0">Add a Provincial Assembly</h4>
                        </div>
                    </div>
